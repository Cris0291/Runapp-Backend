...
namespace RunApp.Infrastructure.Migrations
{
    ...
    [Migration("20250208211916_PererformanceIndexMigration")]
    partial class PererformanceIndexMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RunApp.Domain.Products.Product", b =>
                {
                    ...
                    b.HasIndex("ActualPrice", "ProductId");

                    b.HasIndex("AverageRatings", "ProductId");
